...
class VerficationCodeWithEmail extends StatefulWidget {
  const VerficationCodeWithEmail({super.key});

  @override
  State<VerficationCodeWithEmail> createState() =>
      _VerficationCodeWithEmailState();
}

class _VerficationCodeWithEmailState extends State<VerficationCodeWithEmail> {
                        ...
                        children: [
                          ...
                          Center(
                            child: SvgPicture.asset(
                              AppImages.verficationCodeWithPhone,
                            ),
                          ),
                          SizedBox(height: 20.h),
                          Text.rich(
                            TextSpan(
                              ...
                              children: [
                                TextSpan(
                                  text:
                                      '${authController.forgetPasswordEmailController?.text}',
                                  style: TextStyle(
